...
/**
 * Desrible RNCKPIServiceTestDataProvider
 *
 * @author ezhelao
 * @since 11/2011
 */
public class RNCKPIServiceTestDataProvider {
    public static Object[] provideTestData() {

        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, CHART_PARAM).add(TIME_FROM_QUERY_PARAM, "1200").add(DATE_FROM, "27112011")
                .add(TIME_TO_QUERY_PARAM, "1200").add(DATE_TO_QUERY_PARAM, "28112011").add(SEARCH_PARAM, "RNC1")
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS).build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }

    public static Object[] provideTestDataMultipleElement() {

        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, CHART_PARAM).add(TIME_FROM_QUERY_PARAM, "1200").add(DATE_FROM, "27112011")
                .add(TIME_TO_QUERY_PARAM, "1200").add(DATE_TO_QUERY_PARAM, "28112011").add(SEARCH_PARAM, "ONRM_RootMo_R:RNC02:RNC02,ERICSSON,3G")
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS).build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }
}
