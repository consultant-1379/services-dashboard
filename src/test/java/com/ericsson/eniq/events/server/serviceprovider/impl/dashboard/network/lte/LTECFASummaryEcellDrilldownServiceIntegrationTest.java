...
public class LTECFASummaryEcellDrilldownServiceIntegrationTest extends ServiceBaseTest {
    @Resource(name = "lteCfaSummaryEcellDrilldownService")
    private LTECFASummaryEcellDrilldownService lteCfaSummaryEcellDrilldownService;

    @Test
    @Parameters(source = LTESummaryAccessAreaDrilldownTestDataProvider.class)
    public void testGetData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, lteCfaSummaryEcellDrilldownService);
    }
}
