...
@Stateless
@Local(Service.class)
public class RNCGroupKPIService extends AbstractKPIService {
    ...
    public String getData(final MultivaluedMap<String, String> serviceProviderParameters) {
        ...
        try {
            ...
            if (version.trim().equals(BIS_SOAP_SERVICES_VERSION_SOAP4)) {
                nodeQueryKPIDataType = nodeQuery.getRNCKPISoap4(rncNames, xmlGregorianCalendar);
                nodeQueryKPIDataTypePreviousDay = nodeQuery.getRNCKPISoap4(rncNames, xmlGregorianCalendarPreviousDay);
            } else {
                nodeQueryKPIDataType = nodeQuery.getRNCKPISoap3(rncNames, xmlGregorianCalendar);
                nodeQueryKPIDataTypePreviousDay = nodeQuery.getRNCKPISoap3(rncNames, xmlGregorianCalendarPreviousDay);
            }
            ...
            return handleKPIServiceException(e, RNCGroupKPIService.class.getName());
        }
    }
