...
@Stateless
@Local(Service.class)
public class SummaryHomerRoamerService extends GenericService {
    ...
    public String getTemplatePath() {
        return DASHBOARD_HOMER_ROAMER_SUMMARY;
    }
     ...
     */
    //    @Override
    //    public Map<String, Object> getServiceSpecificTemplateParameters(final MultivaluedMap<String, String> requestParameters, final FormattedDateTimeRange dateTimeRange,
    //            final TechPackList techPackList) {
    //        final Map<String, Object> params = new HashMap<String, Object>();
    //        params.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_SGEH).getPlainAggregationView());
    //        return params;
    //    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
            ...
            final com.ericsson.eniq.events.server.utils.FormattedDateTimeRange dateTimeRange,
            final TechPackList techPackList) {
        final Map<String, Object> params = new HashMap<String, Object>();
