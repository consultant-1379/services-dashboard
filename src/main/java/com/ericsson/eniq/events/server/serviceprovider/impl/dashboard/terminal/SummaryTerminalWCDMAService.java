...
@Stateless
@Local(Service.class)
public class SummaryTerminalWCDMAService extends GenericService {
    /**
     * Fetch the template path for this service
     * This is used when looking up the templateMap.csv
     *
     * @return key for the templateMap.csv file eg dashboard/terminal/summary_wcdma
     */
    @Override
    public String getTemplatePath() {
        return DASHBOARD_TERMINAL_SUMMARY_WCDMA;
    }
