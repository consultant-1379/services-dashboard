    ...
    public String getData(final MultivaluedMap<String, String> serviceProviderParameters) {
        ...
        try {
            ...
            if (version.trim().equals(BIS_SOAP_SERVICES_VERSION_SOAP4)) {
                nodeQueryKPIDataTypes = nodeQuery.getRNCKPIDrillDownSoap4(rncNames, xmlGregorianCalendar);
            } else {
                nodeQueryKPIDataTypes = nodeQuery.getRNCKPIDrillDownSoap3(rncNames, xmlGregorianCalendar);
            }
