...
@Stateless
@Local(Service.class)
public class RNCKPIDrillDownService extends AbstractKPIService {
    ...
    public String getData(final MultivaluedMap<String, String> serviceProviderParameters) {
        ...
        try {
            ...
            if (version.trim().equals(BIS_SOAP_SERVICES_VERSION_SOAP4)) {
                nodeQueryKPIDataTypes = nodeQuery.getRNCKPIDrillDownSoap4(rncID, xmlGregorianCalendar);
            } else {
                nodeQueryKPIDataTypes = nodeQuery.getRNCKPIDrillDownSoap3(rncID, xmlGregorianCalendar);
            }
            ...
            return handleKPIServiceException(e, RNCKPIDrillDownService.class.getName());
        }
