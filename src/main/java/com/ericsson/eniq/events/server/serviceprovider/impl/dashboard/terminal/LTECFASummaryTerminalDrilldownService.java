...
@Stateless
@Local(Service.class)
public class LTECFASummaryTerminalDrilldownService extends GenericService {
    ...
    public String getTemplatePath() {
        return DASHBOARD_LTE_CFA_TERMINAL_SUMMARY_DRILLDOWN;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(MARKETING_NAME_PARAM_UPPERCASE,
                QueryParameter.createStringParameter(requestParameters.getFirst(MARKETING_NAME_PARAM)));
        queryParameters.put(VENDOR_PARAM_UPPER_CASE,
                QueryParameter.createStringParameter(requestParameters.getFirst(VENDOR_PARAM)));
